...
export class BaseComponent<T extends HTMLElement = HTMLElement> {
  ...
  public addEventListener(event: string, listener: (event?: Event) => void, options = false): void {
    this.node.addEventListener(event, listener, options);
  }

  public removeEventListener(event: string, listener: () => void, options = false): void {
